...
<Picture src="alpaca_logo.png" little description="Logo d'ASCOM Alpaca"/>
...
<Picture src="video_SRCPG_proto_starget-ezgif.com-video-to-gif-converter.gif" />

Et voici sa modélisation CAO au cours de son élaboration :

<Picture src="SRCPG_starget.png" />
