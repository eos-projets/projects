...
En tant qu'étudiant passionné d'astronomie, les contraintes budgétaires limitent souvent mes pratique, mais cela n’a fait qu’alimenter ma créativité.. Mes études d'ingénierie et les compétences acquises m'ont naturellement conduit à explorer des solutions DIY pour améliorer mon équipement. **C'est dans cette dynamique que le projet Starget prend forme, visant à concevoir et à optimiser une monture astronomique ultra portable à la fois accessible et performante**.
